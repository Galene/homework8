...
<script language="javascript" type="text/javascript">
	...
	function jMediaRefreshPreview(id) {
		...
		var img = document.id(id + "_preview_img");
		if (img) {
			if (value) {
				img.src = "http://localhost/pro25/" + value;
...
<div>
	...
	<table class="admintable">
		...
		<tr>
			<td class="key">
				<label id="jform_user_id-lbl" for="jform_user_id">
					<?php echo JText::_( 'GMAPFP_USER_LINK' ); ?>:
                </label>
			</td>
			<td  class="fltlft">
				<?php JHtml::_('behavior.modal', 'a.modal_jform_user_id'); ?>
                <input type="text" id="jform_user_id_name" value="<?php echo $this->contactmap->user_name; ?>" disabled="disabled" />
				<div class="button2-left">
					<div class="blank">
						<a class="modal_jform_user_id" title="<?php echo JText::_( 'JLIB_FORM_SELECT_USER' ); ?>" href="index.php?option=com_users&amp;view=users&amp;layout=modal&amp;tmpl=component&amp;field=jform_user_id" rel="{handler: 'iframe', size: {x: 800, y: 500}}">
							<?php echo JText::_( 'JLIB_FORM_SELECT_USER' ); ?>
						</a>
  					</div>
				</div>
				<input type="hidden" id="jform_user_id_id" name="user_id" value="<?php echo $this->contactmap->user_id; ?>" />
			</td>
		</tr>
		<tr>
			<td class="key">
        ...
        <tr>
            ...
            <td valign="center"">
				<div class="fltlft">
					<input type="text" name="image" id="image" value="<?php echo $this->contactmap->image; ?>" readonly="readonly" />
				</div>
				<div class="button2-left">
					<div class="blank">
						<a class="modal" title="<?php echo JText::_('JMODIFY'); ?>" href="index.php?option=com_media&amp;view=images&amp;tmpl=component&amp;asset=com_contactmap&amp;author=0&amp;fieldid=image&amp;folder=" rel="{handler: 'iframe', size: {x: 800, y: 500}}">
						<?php echo JText::_('JMODIFY'); ?></a>
					</div>
				</div>
				<div class="button2-left">
					<div class="blank">
						<a title="<?php echo JText::_('JCLEAR'); ?>" href="#" onclick="jInsertFieldValue('', 'image'); return false;">
						<?php echo JText::_('JCLEAR'); ?></a>
					</div>
				</div>
            </td>
     	</tr>
		<tr>
			...
			<td>
				<img src="<?php if ($this->contactmap->image) echo JURI::base().'..'.'/'.$this->contactmap->image;?>" id="image_preview_img" style="max-width: 400px;" />
            </td>
     	</tr>
    	<tr>
            <td width="110" class="key">
        ...
        <tr>
            ...
            <td valign="center"">
				<div class="fltlft">
					<input type="text" name="icon" id="icon" value="<?php echo $this->contactmap->icon; ?>" readonly="readonly" />
				</div>
				<div class="button2-left">
					<div class="blank">
						<a class="modal" title="<?php echo JText::_('JMODIFY'); ?>" href="index.php?option=com_media&amp;view=images&amp;tmpl=component&amp;asset=com_contactmap&amp;author=0&amp;fieldid=icon&amp;folder=contactmap/icons" rel="{handler: 'iframe', size: {x: 800, y: 500}}">
						<?php echo JText::_('JMODIFY'); ?></a>
					</div>
				</div>
				<div class="button2-left">
					<div class="blank">
						<a title="<?php echo JText::_('JCLEAR'); ?>" href="#" onclick="jInsertFieldValue('', 'icon'); return false;">
						<?php echo JText::_('JCLEAR'); ?></a>
					</div>
				</div>
				<img src="<?php if ($this->contactmap->icon) echo JURI::base().'..'.'/'.$this->contactmap->icon;?>" id="icon_preview_img" style="max-width: 400px;" />
            </td>
     	</tr>
		<tr>
			<td class="key">
