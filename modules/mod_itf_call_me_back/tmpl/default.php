...
$subject		= $contact_name. " " . JText::_( 'MOD_ITF_CALL_ME_BACK_MAIL_TEXT' ).' : '.$contact_phone."\r\n\r\n".stripslashes($subject);
$body			= $contact_name. " " . JText::_( 'MOD_ITF_CALL_ME_BACK_MAIL_TEXT' ).' : '.$contact_phone."\r\n\r\n".stripslashes($body);

if($buttonSubmit == JText::_( 'MOD_ITF_CALL_ME_BACK_SUBMIT' ))
{
	if($contact_phone != "" && $contact_phone != JText::_( 'MOD_ITF_CALL_ME_BACK_PHONE' ) && $contact_name != "" && $contact_name != JText::_( 'MOD_ITF_CALL_ME_BACK_NAME' ) && strlen($contact_phone) >= $mod_itf_call_me_back_phonenumber_length && !containsIlligalStrings($body) && !containsIlligalStrings($subject)) 
	{
...
?>
    ...
    <p class="call_me_back_form_name"><input onclick="doClear(this)" type="text" id="contact_name" name="contact_name" value="<?php echo JText::_( 'MOD_ITF_CALL_ME_BACK_NAME' );?>" class="inputbox" /></p>
    <p class="call_me_back_form_phone"><input type="text"  onclick="doClear(this)" id="contact_phone" name="contact_phone" value="<?php echo JText::_( 'MOD_ITF_CALL_ME_BACK_PHONE' );?>" class="inputbox" /></p>
