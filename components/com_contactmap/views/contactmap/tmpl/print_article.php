...
foreach ($this->rows as $row) {	?>
		...
		<table>
    		<tr>
                <td>
                    <?php
						if ($row->image!=null) { $image=JURI::base().$row->image;?> <img src=<?php echo $image; ?> > <?php }; ?>
                </td>
            </tr>
        </table>
        <table style="width:100%">
            ...
            <?php if ($row->email_to!=null) {?><label class="email"><?php echo JText::_('GMAPFP_EMAIL');?> </label><span class="email"><?php echo $row->email_to;?></span><br /> <?php };?> 
